 ...
 * @param optional nil or *MpimCloseOpts - Optional Parameters:
     * @param "Token" (optional.String) -  Authentication token. Requires scope: &#x60;mpim:write&#x60;
     * @param "Channel" (optional.String) -  MPIM to close.

@return map[string]interface{}
*/

type MpimCloseOpts struct { 
	Token optional.String
	Channel optional.String
}

func (a *MpimApiService) MpimClose(ctx context.Context, localVarOptionals *MpimCloseOpts) (map[string]interface{}, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MpimHistoryOpts - Optional Parameters:
     ...
     * @param "Token" (optional.String) -  Authentication token. Requires scope: &#x60;mpim:history&#x60;
     * @param "Oldest" (optional.Float32) -  Start of time range of messages to include in results.
     * @param "Channel" (optional.String) -  Multiparty direct message to fetch history for.
     * @param "Latest" (optional.Float32) -  End of time range of messages to include in results.

@return map[string]interface{}
*/

type MpimHistoryOpts struct { 
...
func (a *MpimApiService) MpimHistory(ctx context.Context, localVarOptionals *MpimHistoryOpts) (map[string]interface{}, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MpimListOpts - Optional Parameters:
     ...
     * @param "Token" (optional.String) -  Authentication token. Requires scope: &#x60;mpim:read&#x60;
...
type MpimListOpts struct { 
	Cursor optional.String
	Token optional.String
	Limit optional.Int32
}

func (a *MpimApiService) MpimList(ctx context.Context, localVarOptionals *MpimListOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MpimMarkOpts - Optional Parameters:
     * @param "Token" (optional.String) -  Authentication token. Requires scope: &#x60;mpim:write&#x60;
     * @param "Ts" (optional.Float32) -  Timestamp of the most recently seen message.
     * @param "Channel" (optional.String) -  multiparty direct message channel to set reading cursor in.

@return map[string]interface{}
*/

type MpimMarkOpts struct { 
	Token optional.String
	Ts optional.Float32
	Channel optional.String
}

func (a *MpimApiService) MpimMark(ctx context.Context, localVarOptionals *MpimMarkOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MpimOpenOpts - Optional Parameters:
     * @param "Token" (optional.String) -  Authentication token. Requires scope: &#x60;mpim:write&#x60;
     * @param "Users" (optional.String) -  Comma separated lists of users.  The ordering of the users is preserved whenever a MPIM group is returned.

@return map[string]interface{}
*/

type MpimOpenOpts struct { 
	Token optional.String
	Users optional.String
}

func (a *MpimApiService) MpimOpen(ctx context.Context, localVarOptionals *MpimOpenOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *MpimRepliesOpts - Optional Parameters:
     * @param "ThreadTs" (optional.Float32) -  Unique identifier of a thread&#39;s parent message.
     * @param "Token" (optional.String) -  Authentication token. Requires scope: &#x60;mpim:history&#x60;
     * @param "Channel" (optional.String) -  Multiparty direct message channel to fetch thread from.

@return map[string]interface{}
*/

type MpimRepliesOpts struct { 
	ThreadTs optional.Float32
	Token optional.String
	Channel optional.String
}

func (a *MpimApiService) MpimReplies(ctx context.Context, localVarOptionals *MpimRepliesOpts) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
